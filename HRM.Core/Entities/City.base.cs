...
{
    [DataContract]
	public abstract partial class CityBase:EntityBase, IEquatable<CityBase>
	{
		...
		#region IEquatable<CityBase> Members

        public virtual bool Equals(CityBase other)
        {
			if(this.Id==other.Id  && this.Name==other.Name  && this.StateId==other.StateId  && this.IsActive==other.IsActive  && this.CreationDate==other.CreationDate  && this.UpdateDate==other.UpdateDate  && this.UpdateBy==other.UpdateBy  && this.UserIp==other.UserIp )
			{
				return true;
			}
			else
		...
		public virtual void CopyFrom(City other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
