...
{
    [DataContract]
	public abstract partial class GenderBase:EntityBase, IEquatable<GenderBase>
	{
		...
		[FieldNameAttribute("Name",true,false,10)]
		[DataMember (EmitDefaultValue=false)]
		...
		#region IEquatable<GenderBase> Members

        public virtual bool Equals(GenderBase other)
        {
		...
		public virtual void CopyFrom(Gender other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
