...
{
    [DataContract]
	public abstract partial class ContactTypeBase:EntityBase, IEquatable<ContactTypeBase>
	{
		...
		#region IEquatable<ContactTypeBase> Members

        public virtual bool Equals(ContactTypeBase other)
        {
		...
		public virtual void CopyFrom(ContactType other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
