...
{
    [DataContract]
	public abstract partial class AttendanceVariableBase:EntityBase, IEquatable<AttendanceVariableBase>
	{
		...
		#region IEquatable<AttendanceVariableBase> Members

        public virtual bool Equals(AttendanceVariableBase other)
        {
			if(this.Id==other.Id  && this.Name==other.Name  && this.Description==other.Description  && this.IsActive==other.IsActive  && this.CreationDate==other.CreationDate  && this.UpdateDate==other.UpdateDate  && this.UpdateBy==other.UpdateBy  && this.UserIp==other.UserIp )
			{
				return true;
			}
			else
		...
		public virtual void CopyFrom(AttendanceVariable other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
