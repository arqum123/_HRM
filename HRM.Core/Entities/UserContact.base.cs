...
{
    [DataContract]
	public abstract partial class UserContactBase:EntityBase, IEquatable<UserContactBase>
	{
		...
		[FieldNameAttribute("ContactTypeID",true,true,4)]
		[DataMember (EmitDefaultValue=false)]
		...
		#region IEquatable<UserContactBase> Members

        public virtual bool Equals(UserContactBase other)
        {
			if(this.Id==other.Id  && this.UserId==other.UserId  && this.ContactTypeId==other.ContactTypeId  && this.Detail==other.Detail  && this.IsActive==other.IsActive  && this.CreationDate==other.CreationDate  && this.UpdateDate==other.UpdateDate  && this.UpdateBy==other.UpdateBy  && this.UserIp==other.UserIp )
			{
				return true;
			}
			else
		...
		public virtual void CopyFrom(UserContact other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
				this.UserId=other.UserId;
				this.ContactTypeId=other.ContactTypeId;
