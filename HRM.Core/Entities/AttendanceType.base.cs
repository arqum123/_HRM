...
{
    [DataContract]
	public abstract partial class AttendanceTypeBase:EntityBase, IEquatable<AttendanceTypeBase>
	{
		...
		#region IEquatable<AttendanceTypeBase> Members

        public virtual bool Equals(AttendanceTypeBase other)
        {
			if(this.Id==other.Id  && this.Name==other.Name  && this.IsActive==other.IsActive  && this.CreationDate==other.CreationDate  && this.UpdateDate==other.UpdateDate  && this.UpdateBy==other.UpdateBy  && this.UserIp==other.UserIp )
			{
				return true;
			}
			else
		...
		public virtual void CopyFrom(AttendanceType other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
