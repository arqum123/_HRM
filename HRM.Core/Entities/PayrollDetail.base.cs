...
{
    [DataContract]
	public abstract partial class PayrollDetailBase:EntityBase, IEquatable<PayrollDetailBase>
	{
        ...
        public virtual bool Equals(PayrollDetailBase other)
        {
		...
		public virtual void CopyFrom(PayrollDetail other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
