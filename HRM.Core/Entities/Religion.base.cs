...
{
    [DataContract]
	public abstract partial class ReligionBase:EntityBase, IEquatable<ReligionBase>
	{
		...
		#region IEquatable<ReligionBase> Members

        public virtual bool Equals(ReligionBase other)
        {
		...
		public virtual void CopyFrom(Religion other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
