...
{
    [DataContract]
	public abstract partial class UserDepartmentBase:EntityBase, IEquatable<UserDepartmentBase>
	{
		...
		#region IEquatable<UserDepartmentBase> Members

        public virtual bool Equals(UserDepartmentBase other)
        {
			if(this.Id==other.Id  && this.UserId==other.UserId  && this.DepartmentId==other.DepartmentId  && this.EffectiveDate==other.EffectiveDate  && this.RetiredDate==other.RetiredDate  && this.CreationDate==other.CreationDate  && this.UpdateDate==other.UpdateDate  && this.UpdateBy==other.UpdateBy  && this.UserIp==other.UserIp )
			{
				return true;
			}
			else
		...
		public virtual void CopyFrom(UserDepartment other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
