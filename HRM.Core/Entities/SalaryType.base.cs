...
{
    [DataContract]
	public abstract partial class SalaryTypeBase:EntityBase, IEquatable<SalaryTypeBase>
	{
		...
		#region IEquatable<SalaryTypeBase> Members

        public virtual bool Equals(SalaryTypeBase other)
        {
		...
		public virtual void CopyFrom(SalaryType other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
