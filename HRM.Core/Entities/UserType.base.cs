...
{
    [DataContract]
	public abstract partial class UserTypeBase:EntityBase, IEquatable<UserTypeBase>
	{
		...
		#region IEquatable<UserTypeBase> Members

        public virtual bool Equals(UserTypeBase other)
        {
		...
		public virtual void CopyFrom(UserType other)
        {
			if(other!=null)
			{
				this.Id=other.Id;
