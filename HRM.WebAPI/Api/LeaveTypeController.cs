...
namespace HRM.WebAPI.Api
{
    ...
    {
        ILeaveTypeService leavetypeService= IoC.Resolve<ILeaveTypeService>("LeaveTypeService");
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return leavetypeService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return leavetypeService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
