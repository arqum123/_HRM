...
{
    public class AttendanceDetailController : ApiControllerBase
    {
        IAttendanceDetailService attendancedetailService= IoC.Resolve<IAttendanceDetailService>("AttendanceDetailService");
        ...
        public DataTransfer<List<GetOutput>> GetAll()
        {
            ...
            try
            {
                return attendancedetailService.GetAll();
            }
            catch (Exception ex)
            {
        ...
        public DataTransfer<GetOutput> Get(string id)
        {
            ...
            try
            {
                return attendancedetailService.Get(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return attendancedetailService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return attendancedetailService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<string> Delete(string id)
        {
            ...
            try
            {
                return attendancedetailService.Delete(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
