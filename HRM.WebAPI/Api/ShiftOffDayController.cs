...
{
    public class ShiftOffDayController : ApiControllerBase
    {
        IShiftOffDayService shiftoffdayService= IoC.Resolve<IShiftOffDayService>("ShiftOffDayService");
        ...
        public DataTransfer<List<GetOutput>> GetAll()
        {
            ...
            try
            {
                return shiftoffdayService.GetAll();
            }
            catch (Exception ex)
            {
        ...
        public DataTransfer<GetOutput> Get(string id)
        {
            ...
            try
            {
                return shiftoffdayService.Get(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return shiftoffdayService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return shiftoffdayService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<string> Delete(string id)
        {
            ...
            try
            {
                return shiftoffdayService.Delete(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
