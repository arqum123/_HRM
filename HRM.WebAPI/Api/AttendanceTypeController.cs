...
{
    public class AttendanceTypeController : ApiControllerBase
    {
        IAttendanceTypeService attendancetypeService= IoC.Resolve<IAttendanceTypeService>("AttendanceTypeService");
        ...
        public DataTransfer<GetOutput> Get(string id)
        {
            ...
            try
            {
                return attendancetypeService.Get(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return attendancetypeService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return attendancetypeService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<string> Delete(string id)
        {
            ...
            try
            {
                return attendancetypeService.Delete(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
