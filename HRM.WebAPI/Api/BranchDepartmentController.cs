...
namespace HRM.WebAPI.Api
{
    ...
    {
        IBranchDepartmentService branchdepartmentService= IoC.Resolve<IBranchDepartmentService>("BranchDepartmentService");
        ...
        public DataTransfer<List<GetOutput>> GetAll()
        {
            ...
            try
            {
                return branchdepartmentService.GetAll();
            }
            catch (Exception ex)
            {
        ...
        public DataTransfer<GetOutput> Get(string id)
        {
            ...
            try
            {
                return branchdepartmentService.Get(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return branchdepartmentService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return branchdepartmentService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<string> Delete(string id)
        {
            ...
            try
            {
                return branchdepartmentService.Delete(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
