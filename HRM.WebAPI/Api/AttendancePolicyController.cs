...
{
    public class AttendancePolicyController : ApiControllerBase
    {
        IAttendancePolicyService attendancepolicyService= IoC.Resolve<IAttendancePolicyService>("AttendancePolicyService");
        ...
        public DataTransfer<List<GetOutput>> GetAll()
        {
            ...
            try
            {
                return attendancepolicyService.GetAll();
            }
            catch (Exception ex)
            {
        ...
        public DataTransfer<GetOutput> Get(string id)
        {
            ...
            try
            {
                return attendancepolicyService.Get(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return attendancepolicyService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return attendancepolicyService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<string> Delete(string id)
        {
            ...
            try
            {
                return attendancepolicyService.Delete(id);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
