...
namespace HRM.WebAPI.Api
{
    ...
    {
        IDepartmentService departmentService= IoC.Resolve<IDepartmentService>("DepartmentService");
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return departmentService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return departmentService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
