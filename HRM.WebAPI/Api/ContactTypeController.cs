...
namespace HRM.WebAPI.Api
{
    ...
    {
        IContactTypeService contacttypeService= IoC.Resolve<IContactTypeService>("ContactTypeService");
        ...
        public DataTransfer<PostOutput> Post(PostInput Input)
        {
            ...
            try
            {
                return contacttypeService.Insert(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
        ...
        public DataTransfer<PutOutput> Put(PutInput Input)
        {
            ...
            try
            {
                return contacttypeService.Update(Input);
            }
            catch (Exception ex)
            {
                transfer.IsSuccess = false;
